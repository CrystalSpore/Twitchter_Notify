...
var ChatUser = /** @class */ (function () {
    function ChatUser(prefix, userData, client) {
    ...
    ChatUser.prototype.getUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.userId) {
                    return [2 /*return*/, this._client._twitchClient.users.getUser(this.userId)];
                }
                return [2 /*return*/, this._client._twitchClient.users.getUserByName(this._userName)];
            });
        });
    };
    __decorate([
