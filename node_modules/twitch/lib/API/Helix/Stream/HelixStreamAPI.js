...
var HelixStreamAPI = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.data.map(function (streamData) { return new HelixStream_1.default(streamData, _this._client); })];
                }
            });
        });
    };
    HelixStreamAPI.prototype.getStreamByUserName = function (userName) {
        return __awaiter(this, void 0, void 0, function () {
            var streams;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getStreams({ userName: userName })];
                    case 1:
                        streams = _a.sent();
    ...
    HelixStreamAPI.prototype.getStreamByUserId = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getStreams({ user: user })];
                    case 1:
                        streams = _a.sent();
                        return [2 /*return*/, streams.length ? streams[0] : null];
                }
