...
var MessageParam = /** @class */ (function () {
    function MessageParam(value, trailing) {
        this.value = value;
...
var Message = /** @class */ (function () {
    ...
    Message.parseTags = function (raw) {
        ...
        try {
            for (var tagStrings_1 = __values(tagStrings), tagStrings_1_1 = tagStrings_1.next(); !tagStrings_1_1.done; tagStrings_1_1 = tagStrings_1.next()) {
                ...
                var _a = __read(tagString.split('=', 2), 2), tagName = _a[0], tagValue = _a[1];
            ...
            try {
                if (tagStrings_1_1 && !tagStrings_1_1.done && (_b = tagStrings_1.return)) _b.call(tagStrings_1);
            }
    ...
    Message.create = function (client, params) {
        ...
        var parsedParams = {};
        try {
            for (var _a = __values(Object.entries(this.PARAM_SPEC)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var _c = __read(_b.value, 2), paramName = _c[0], paramSpec = _c[1];
    ...
    Message.prototype.parseParams = function () {
        if (this._params) {
            ...
            var parsedParams = {};
            try {
                for (var _a = __values(Object.entries(paramSpecList)), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var _c = __read(_b.value, 2), paramName = _c[0], paramSpec = _c[1];
