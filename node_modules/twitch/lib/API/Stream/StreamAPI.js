...
var StreamAPI = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._client.apiCall({ url: "streams/" + channelId })];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, new _1.default(data, this._client)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._client.apiCall({ url: 'streams', query: query })];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data.streams.map(function (streamData) { return new _1.default(streamData, _this._client); })];
                }
            });
        });
    };
    StreamAPI.prototype.getAllStreams = function (page, limit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getStreams(undefined, undefined, undefined, 'all', page, limit)];
            });
        });
    };
    StreamAPI.prototype.getAllLiveStreams = function (page, limit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getStreams(undefined, undefined, undefined, 'live', page, limit)];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._client.apiCall({ url: 'streams/followed', query: query, scope: 'user_read' })];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data.streams.map(function (streamData) { return new _1.default(streamData, _this._client); })];
                }
