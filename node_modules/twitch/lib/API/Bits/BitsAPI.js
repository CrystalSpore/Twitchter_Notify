...
var BitsAPI = /** @class */ (function (_super) {
    ...
    BitsAPI.prototype.getCheermotes = function (channel) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = {};
                        if (channel) {
                            query.channel_id = UserTools_1.default.getUserId(channel);
                        }
                        return [4 /*yield*/, this._client.apiCall({ url: 'bits/actions', query: query })];
                    case 1:
                        data = _a.sent();
