...
export declare type TwitchApiCallType = 'kraken' | 'helix' | 'custom';
...
export default class Twitch {
    ...
    private readonly _chatClients;
    private readonly _pubSubClients;
    static withCredentials(clientId: string, accessToken?: string, refreshConfig?: RefreshConfig, config?: Partial<TwitchConfig>): Twitch;
    ...
    getPubSubClient(identifier?: string): SingleUserPubSubClient;
