...
var User = /** @class */ (function () {
    ...
    User.prototype.getChannel = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._client.channels.getChannel(this)];
            });
        });
    };
    ...
    User.prototype.getSubscriptionTo = function (channel) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._client.users.getSubscriptionData(this, channel)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_1 = _a.sent();
                        if (e_1 instanceof NoSubscriptionProgram_1.default || e_1 instanceof NotSubscribed_1.default) {
    ...
    User.prototype.getFollows = function (page, limit, orderBy, orderDirection) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._client.users.getFollowedChannels(this, page, limit, orderBy, orderDirection)];
            });
        });
    };
    User.prototype.getFollowTo = function (channel) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._client.users.getFollowedChannel(this, channel)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_2 = _a.sent();
                        if (e_2 instanceof NotFollowing_1.default) {
                            return [2 /*return*/, false];
                        }
                        throw e_2;
                    case 3: return [2 /*return*/];
