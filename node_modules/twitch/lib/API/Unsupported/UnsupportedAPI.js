            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._client.apiCall({ url: "https://tmi.twitch.tv/group/user/" + channel + "/chatters", type: 'custom' })];
                    case 1:
                        data = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._client.apiCall({ url: "channels/" + channelId + "/events" })];
                    case 1:
                        data = _a.sent();
